...
import com.usermanagement.userdto.SendRequest;
...
public class UserLoginController {
	...
	public List<UserRoleMap> getUserRoleByUserType(@PathVariable String userTYpe) {
		...
		return loginService.getUserRoleByUserType(userTYpe);
	}

	@PostMapping(value = "/sendEmailForCreation", consumes = "application/json", produces = "application/json")
	public void sendEmail(@RequestBody SendRequest request) {

		loginService.sendEmail(request.getEmailId(), request.getLoginId(), request.getPassword());
	}
